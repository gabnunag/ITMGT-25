...
def eta(first_stop, second_stop, route_map):
    ...
    #Peforms task with regard to checking stops within the map, returns a message depending on the conditions laid out
    if first_stop in route_map or second_stop in route_map:
        return "Invalid stops."

    #Performs task with regard to checking the connections/intersections between stops
